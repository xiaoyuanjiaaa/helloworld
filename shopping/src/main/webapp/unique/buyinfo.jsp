...
<script type="text/javascript" src="/shopping/unique/js/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/shopping/unique/js/js.js"></script>
<script type="text/javascript" src="/shopping/unique/js/payfor.js"></script>

<script type="text/javascript">

	function car(){
		$.post('/shopping/un_sh_car.sw',{
			orderNo:$('input [name="orderNo"]').val(),
			cou:$('input [name="cou"]').val(),
...
<div class="hrader" id="header">
  <div class="top">
   <a href="/shopping/unique/login.html" style="color:#C94E13;">请登录</a> 
   <a href="/shopping/unique/reg.html">注册</a>
   <ul class="topNav">
     <li><a href="/shopping/unique/vipOrder.html">我的订单 </a></li>
    <li class="gouwuche"><a href="/shopping/unique/car.html">购物车</a> <strong style="color:#C94E13;">3</strong></li>
    <li class="shoucangjia"><a href="/shopping/unique/vipShoucang.html">收藏夹</a></li>
 ...
 <div class="mid">
  ...
  <form action="#" method="get" class="subBox">
   <div class="subBox2">
    ...
    <input type="image" src="/shopping/unique/images/sub.jpg" width="95" height="32" class="subImg" />
    <div class="hotci">
     <a href="#">iPhone</a>
     <a href="#">三星</a>
     <a href="#">小米</a>
  ...
  <div class="ding-gou">
   <div class="ding">
    <a href="/shopping/unique/order.html"><img src="/shopping/unique/images/dingdan.jpg" width="106" height="32" /></a>
   </div><!--ding/-->
   <div class="gou">
    <a href="/shopping/unique/car.html"><img src="/shopping/unique/images/gouwuche.jpg" width="126" height="32" /></a>
   </div><!--gou/-->
   <div class="clears"></div>
  </div><!--ding-gou/-->
 </div><!--mid-->
 <div class="navBox navBg1">
  <ul class="nav">
   <li><a href="/shopping/unique/index.html">首页</a></li>
   <li><a href="/shopping/unique/buy.html">手机</a></li>
   <li><a href="/shopping/unique/sell.html">电脑</a></li>
   <li><a href="/shopping/unique/vip.html">个人中心</a></li>
   <li><a href="/shopping/unique/help.html">帮助</a></li>
   <div class="clears"></div>
  </ul><!--nav/-->
 </div><!--navBox/-->
 <div class="bn"><img src="/shopping/unique/images/dingzhi.jpg" width="972" height="167" /></div>
 <div class="buyinfo">
  <div class="buyDtl">
   <div class="buyDtlLeft">
    <div class="buyimgBig"><!-- el表达式 直接获取对象  《c:forEach》遍历集合  -->
     <img src="${info.shopImg }" width="360" height="360" />
    </div><!--buyimgBig/-->
   </div><!--buyDtlLeft/-->
   <div class="buyDtlRight">
   
    <h3>${info.shopName }</h3>
    <h4>【赠送精品蓝牙耳机+超大容量移动电源】${info.resolution }&nbsp;${info.os }&nbsp;${info.quality }</h4>
    <h5>价格：<span>￥</span><strong id="price_item_1"><input type="text" disabled="disabled" name="orderprice" value="${info.sole }"></strong></h5>
    <table class="buyTable">
     <tr>
      <th width="70">商品编号</th>
      <td><input type="text" disabled="disabled" name="orderNo" value="${shopno }"><input type="hidden" name="shopid" value="${info.shopId }"></td>
     </tr>
     <tr>
      <th width="70">运费</th>
      <td>包邮</td>
      ...
      <td>
       <div class="p_number">
		<div class="f_l add_chose">
			...
			<input type="text" name="cou" value="1" id="qty_item_1" onKeyUp="setAmount.modify('#qty_item_1')" class="text" />
			<a class="add" onClick="setAmount.add('#qty_item_1')" href="javascript:void(0)">+</a>
		</div>
		
		<div class="f_l buy">
			总价：<span class="total-font" id="total_item_1">${info.sole }</span>
			<input type="hidden" name="total" id="total_price" value="total_price" />
		</div>
    ...
    <div class="goumai">
     <a href="/shopping/un_sh_sell.sw" class="buy-gou">立即购买</a>
     <input type="button" onclick="car()" class="buy-mai" value="加入购物车" />
    </div><!--goumai/-->
