...
<div class="hrader" id="header">
  <div class="top">
   <a href="/shopping/unique/login.jsp" style="color:#C94E13;">请登录</a> 
 ...
 <div class="mid">
  ...
  <form action="/shopping/un_sh_list.sw" method="post" class="subBox">
   <div class="subBox2">
    <input type="text" class="subText" />
    <input type="submit" src="/shopping/unique/images/sub.jpg" width="95" height="32" class="subImg" />
    <div class="hotci">
     <a href="#">iPhone</a>
     <a href="#">三星</a>
     <a href="#">小米</a>
 ...
 <form action="/shopping/un_sh_list.sw" method="post" class="proDingzhi">
  <img src="/shopping/unique/images/dingzhi.jpg" width="972" height="167" />
  <div class="bdsharebuttonbox">
  <a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></div>
<!-- <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/365)];</script> -->
  <table class="proDSel">
   <tr>
    <th>
     <h3>品牌</h3>
    ...
    <td>
     <div class="proPosition">
      ...
      <input type="image" src="/shopping/unique/images/queding.png" class="queen2" />
      <div class="more-shou">
       <span class="more">
        更多 &gt;
       </span>
    ...
    <td>
     <div class="proPosition">
      ...
      <div class="jiage">
       <input type="text" />&nbsp;-&nbsp;
       <input type="text" />&nbsp;
       <input type="image" src="/shopping/unique/images/queding.png" class="queen" />
      </div><!--jiage/-->
     </div>
    </td>
   </tr>
  ...
  <c:forEach items="${shoplist }" var="shop">
   <dl>
    <dt><a href="/shopping/buyinfo.sw?shopId=${shop.shopId }"><img src="${shop.shopImg }" /></a></dt>
    <dd>
     <h3>￥${shop.sole }</h3>
     <div class="phonePars">
     ${shop.shopName }&nbsp;${shop.sort.sortName }&nbsp;${shop.MBRAM }+${shop.ROM }&nbsp;${shop.os }
     </div><!--phonePar/-->
     <div class="xiaoliang">
     ...
     <div class="jiaru-shoucang">
      ...
      <span class="shoucangCar"><a href="/shopping/unique/quanjing/index.html">选用此模型</a></span>>
      <div class="clears"></div>
     </div><!--jiaru-shoucang/-->
    </dd>
   </dl>
